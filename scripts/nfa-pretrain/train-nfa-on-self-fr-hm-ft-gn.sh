...
ns-train $MODEL_NAME \
    ...
    --pipeline.pop-sdf-pretrain False \
    --pipeline.fix-hashmap True \
    --timestamp $TMP_STR \
    --trainer.load-dir /n/fs/3d-indoor/sdfstudio_outputs/3d-indoor/ngp-sdf-baseline/$DATA_ID \
