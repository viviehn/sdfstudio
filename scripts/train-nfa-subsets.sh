...
OMP_NUM_THREADS=4 ns-train $MODEL_NAME \
    ...
    --trainer.steps-per-eval-batch 5000 --trainer.steps-per-eval-image 5000 \
...
FINAL_PATH=/n/fs/3d-indoor/sdfstudio_outputs/3d-indoor/subsets/$EXP_NAME/$DATA_ID/$MODEL_NAME
mkdir -p $FINAL_PATH
