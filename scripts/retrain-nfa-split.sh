...
EXP_NAME=$DATA_ID/rgb_retraining
...
OMP_NUM_THREADS=4 ns-train $MODEL_NAME \
    ...
    --pipeline.model.sdf-field.pop-geometry-encoding True \
    --pipeline.model.sdf-field.fix-appearance-net True \
    --pipeline.model.sdf-field.pop-appearance-net False \
    ...
    --timestamp $TMP_STR \
    --trainer.load-dir $BASE_OUTDIR/split_appearance/785e7504b9/rgb-training/nfa-split/20241007_181616_23498/sdfstudio_models \
