...
ns-train $MODEL_NAME \
    ...
    --trainer.max-num-iterations 6001  --trainer.steps_per_save 2000\
    ...
    --timestamp $TMP_STR \
    --trainer.load-dir /n/fs/3d-indoor/sdfstudio_outputs/3d-indoor/multiscene/20-scenes/neus-facto-angelo-multi/20240721_013116_2683/sdfstudio_models \
    --pipeline.pop_sdf_pretrain True \
...
FINAL_PATH=/n/fs/3d-indoor/sdfstudio_outputs/3d-indoor/feature-exploration/$EXP_NAME/$DATA_ID/$MODEL_NAME
