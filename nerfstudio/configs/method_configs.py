...
from nerfstudio.fields.multiscene_sdf_field import MultisceneSDFFieldConfig
...
descriptions = {
    ...
    "neus-facto-angelo-multi": "Multi scene training"
}
...
method_configs["neus-facto-angelo-multi"] = Config(
    method_name="neus-facto-angelo-multi",
    trainer=TrainerConfig(
        steps_per_eval_image=5000,
        steps_per_eval_batch=5000,
        steps_per_save=20000,
    ...
    pipeline=MultiscenePipelineConfig(
        ...
        model=NeuSFactoModelConfig(
            ...
            far_plane=1000.0,
            overwrite_near_far_plane=True,
            sdf_field=MultisceneSDFFieldConfig(
                num_scenes=3,
                use_grid_feature=True,
                num_layers=1,
                num_layers_color=4,
