...
from nerfstudio.data.datamanagers.multiscene_datamanager import MultisceneDataManagerConfig
...
from nerfstudio.fields.split_field import SplitFieldConfig
from nerfstudio.fields.multiscene_split_field import MultisceneSplitFieldConfig
...
from nerfstudio.pipelines.multiscene_pipeline import MultiscenePipelineConfig
...
descriptions = {
    ...
    "nfa-split": "neus-facto with split appearance encoder",
}
...
method_configs["nfa-split"] = Config(
    method_name="nfa-split",
    trainer=TrainerConfig(
        steps_per_eval_image=5000,
        steps_per_eval_batch=5000,
        steps_per_save=20000,
...
method_configs["nfa-multi"] = Config(
    method_name="nfa-multi",
    trainer=TrainerConfig(
        steps_per_eval_image=5000,
        steps_per_eval_batch=5000,
        steps_per_save=20000,
    ...
    pipeline=MultiscenePipelineConfig(
        ...
        model=NeuSFactoModelConfig(
            ...
            far_plane=1000.0,
            overwrite_near_far_plane=True,
            sdf_field=MultisceneSplitFieldConfig(
                use_grid_feature=True,
                num_layers=1,
                num_layers_color=4,
                hidden_dim=256,
